...
<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    ...
    >
    <div class="flex rounded-lg" :class="$style.login">

      <a
        href="#"
        class="flex items-center text-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white min-w-[360px]"
      >
      </a>
      <div
        class="flex align-middle w-full min-w-[400px] h-[400px] bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0  dark:border-gray-700"
      >
        <div class="w-full flex flex-col justify-center space-y-4 md:space-y-6 sm:p-8">
          <h1
...
.login {
  background-image: url("https://image.baodauthau.vn/1200x630/Uploaded/2024/qjmfn/2023_08_25/banner-6675.jpg");
